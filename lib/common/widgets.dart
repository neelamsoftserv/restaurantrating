...
class Widgets {
  ...
  Widget rowTile({required String label}){
    return  Container(
      ...
      child: Row(
        ...
        children: [
          Text(label,style: Widgets.common18px600(),),
    ...
    return  Container(
      ...
      child: Column(
        children: [
          ...
          Text(desc,style: Widgets.common16px400(),)
        ],
      ),
    );
  }

  Widget rowLocationTile({required String label,
    ...
    return  Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            location,style: Widgets.common15px400(),),
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(child: Text("$distance from Location",style: Widgets.common15px400(),)),
                  ],
                ),
              ),
  ...
  Widget progressBarTile({required BuildContext context,required String starText, required String progressImage, required String progressPercentage}){
    return  Row(
